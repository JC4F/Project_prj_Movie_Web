 ...
 * @author win
 */
@WebServlet(name = "AdninHandleAccServlet", urlPatterns = {"/admin-handleacc"})
public class AdminHandleAccServlet extends HttpServlet {

    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        request.getRequestDispatcher("admin-handle-acc.jsp").forward(request, response);
    }
