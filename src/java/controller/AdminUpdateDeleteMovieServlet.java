 ...
 * @author win
 */
@WebServlet(name = "AdminUpdateDeleteMovieServlet", urlPatterns = {"/admin-handleUDmovie"})
public class AdminUpdateDeleteMovieServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (action.equals("update")) {
            ...
            request.getRequestDispatcher("admin-update-movie.jsp").forward(request, response);
        }
